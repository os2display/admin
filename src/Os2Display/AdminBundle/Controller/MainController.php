...
class MainController extends Controller {
  ...
  public function indexAction() {
    ...
    $externalAssets = $this->container->hasParameter('external_assets') ? $this->container->getParameter('external_assets') : [];
    ...
    $externalBootstrap = $this->container->hasParameter('external_bootstrap') ? $this->container->getParameter('external_bootstrap') : [];
    ...
    return $this->render('Os2DisplayAdminBundle:Main:index.html.twig', array(
      'assets' => $mergedAssets,
      'apps' => $mergedApps,
