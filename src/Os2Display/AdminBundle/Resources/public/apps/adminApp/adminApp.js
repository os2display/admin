...
angular.module('adminApp').config(['$routeProvider', '$translateProvider', function ($routeProvider, $translateProvider) {
  ...
  .useStaticFilesLoader({
    prefix: 'bundles/os2displayadmin/apps/adminApp/translations/locale-',
    suffix: '.json'
  })
  ...
  .when('/admin', {
    ...
    templateUrl: 'bundles/os2displayadmin/apps/adminApp/dashboard/admin-dashboard.html?' + window.config.version
  })
  // Users
  .when('/user', {
    controller: 'AdminUserController',
    templateUrl: 'bundles/os2displayadmin/apps/adminApp/user/admin-user.html?' + window.config.version
  })
  .when('/admin/users', {
    controller: 'AdminUsersController',
    templateUrl: 'bundles/os2displayadmin/apps/adminApp/user/admin-users.html?' + window.config.version
  })
  .when('/admin/user/:id', {
    controller: 'AdminUserController',
    templateUrl: 'bundles/os2displayadmin/apps/adminApp/user/admin-user.html?' + window.config.version
  ...
  .when('/admin/groups', {
    ...
    templateUrl: 'bundles/os2displayadmin/apps/adminApp/group/admin-groups.html?' + window.config.version
  })
  .when('/admin/group/:id', {
    controller: 'AdminGroupController',
    templateUrl: 'bundles/os2displayadmin/apps/adminApp/group/admin-group.html?' + window.config.version
  })
}]);
