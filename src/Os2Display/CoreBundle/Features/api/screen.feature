...
Feature: admin
  ...
  Scenario: Get screens
    ...
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Screen'" should return 0 element
  ...
  Scenario: Get screens
    ...
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Screen'" should return 2 elements
  ...
  Scenario: Get screens
    ...
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Screen'" should return 1 element

  Scenario: Remove screen
    When I send a "DELETE" request to "/api/screen/1"
    Then the response status code should be 200
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Screen'" should return 0 elements
