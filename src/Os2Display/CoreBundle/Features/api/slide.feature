...
Feature: admin
  ...
  Scenario: Get slides
    ...
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Slide'" should return 0 element
  ...
  Scenario: Get slides
    ...
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Slide'" should return 2 elements
  ...
  Scenario: Get slides
    ...
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Slide'" should return 1 element

  Scenario: Remove slide
    When I send a "DELETE" request to "/api/slide/1"
    Then the response status code should be 200
    And the SQL query "SELECT * FROM ik_grouping WHERE entity_type = 'Os2Display\\CoreBundle\\Entity\\Slide'" should return 0 elements
