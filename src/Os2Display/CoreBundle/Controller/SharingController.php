...
class SharingController extends Controller {
  ...
  public function sharedChannelGetAction($id, $index) {
    ...
    $sharingService = $this->container->get('os2display.sharing_service');
    ...
    $sharedChannel = $doctrine->getRepository('Os2DisplayCoreBundle:SharedChannel')->findOneByUniqueId($id);
  ...
  public function sharedChannelSaveAction(Request $request) {
    ...
    $em = $doctrine->getManager();
    $sharedChannelRepository = $doctrine->getRepository('Os2DisplayCoreBundle:SharedChannel');
    $screenRepository = $doctrine->getRepository('Os2DisplayCoreBundle:Screen');
  ...
  public function sharingIndexesSaveAction(Request $request) {
    ...
    $doctrine = $this->getDoctrine();
    $em = $doctrine->getManager();
    $sharingIndexRepository = $doctrine->getRepository('Os2DisplayCoreBundle:SharingIndex');
