...
class Slide extends ApiEntity implements GroupableEntity {
   ...
   * Add mediaOrder
   *
   * @param \Os2Display\CoreBundle\Entity\MediaOrder $mediaOrder
   * @return Slide
   */
  public function addMediaOrder(\Os2Display\CoreBundle\Entity\MediaOrder $mediaOrder) {
   ...
   * @return Slide
   */
  public function removeMediaOrder(\Os2Display\CoreBundle\Entity\MediaOrder $mediaOrder) {
