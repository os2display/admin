...
class ScreenTemplate {
   ...
   * Add screen
   *
   * @param \Os2Display\CoreBundle\Entity\Screen $screen
   * @return ScreenTemplate
   */
  public function addScreen(\Os2Display\CoreBundle\Entity\Screen $screen) {
    $this->screens[] = $screen;
   ...
   * @return ScreenTemplate
   */
  public function removeScreen(\Os2Display\CoreBundle\Entity\Screen $screen) {
