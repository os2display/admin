angular.module('templateModule').directive('slideshowOrderEditor', [
  function () {
    return {
      restrict: 'E',
      replace: true,
      ...
      templateUrl: '/bundles/os2displaydefaulttemplate/apps/templateModule/slideshow-order-editor.html'
    };
  }
]);
