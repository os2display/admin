angular.module('templateModule').directive('backgroundEditorStaticColors', [
  'mediaFactory', function (mediaFactory) {
    return {
      ...
      templateUrl: '/bundles/os2displaydefaulttemplate/apps/templateModule/background-editor-static-colors.html'
    };
  }
]);
