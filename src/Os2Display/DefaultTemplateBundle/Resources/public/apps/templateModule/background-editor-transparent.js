angular.module('templateModule').directive('backgroundEditorTransparent', [
  'mediaFactory', function (mediaFactory) {
    return {
      ...
      templateUrl: '/bundles/os2displaydefaulttemplate/apps/templateModule/background-editor-transparent.html'
    };
  }
]);
