    ...
    window.slideFunctions['bib-events'] = {
        ...
        setup: function setupEventsSlide(scope) {
            ...
            if (slide.options.use_box_heights) {
                var vhMarginAroundEachEvent = ((slide.external_data.events_pr_slide - 1) * 2);
                var vhMarginPage = 10;
        ...
        run: function runEventsSlide(slide, region) {
            ...
            var slide_duration = slide.options.subslide_duration ? slide.options.subslide_duration : 15;
