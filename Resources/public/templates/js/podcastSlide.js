/**
 * Podcast slide, based on the basic-slide.
 */

// Register the function, if it does not already exist.
if (!window.slideFunctions['podcast']) {
  window.slideFunctions['podcast'] = {
    /**
     * Setup the slide for rendering.
     * @param scope
     *   The slide scope.
     */
    setup: function setupPodcastSlide(scope) {
     ...
     */
    run: function runPodcastSlide(slide, region) {
        // Log slide-info before starting up.
        region.itkLog.info("Running Podcast: " + slide.title);
