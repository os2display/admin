 ...
 */
angular.module('ikApp').directive('ikSlide', ['slideFactory', 'templateFactory', 'itkLogFactory', 'configuration',
  function (slideFactory, templateFactory, itkLogFactory, configuration) {
    'use strict';
