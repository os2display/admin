 ...
 */
angular.module('ikApp').directive('ikSlideEditable', ['templateFactory', 'itkLogFactory', 'configuration',
  function (templateFactory, itkLogFactory, configuration) {
    ...
    return {
      ...
      templateUrl: '/app/shared/elements/slide/slide-edit.html?' + configuration.version
    };
  }
]);
