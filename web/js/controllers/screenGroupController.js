/**
 * @file
 * Contains the screen group controllers.
 */

/**
 * Screen group controller. Controls the screen group creation process.
 */
ikApp.controller('ScreenGroupController', ['$scope', '$location', '$routeParams', 'screenFactory',
  function($scope, $location, $routeParams, screenFactory) {
    $scope.steps = 2;
    $scope.screenGroup = {};
