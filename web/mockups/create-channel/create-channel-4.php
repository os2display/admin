...
<html>
  ...
  <div class="layout-wrapper">
    <section id="create-channel-four" class="create-channel--section">
      <div class="create-channel--content--channel-four">
        <h1 class="create-channel--header">Opret kanal - slides rækkefølge (4/4)</h1>
        <p class="create-channel--header-description">Træk eller brug pilene for at vælge i hviklen rækkefølge dine slides skal vises.</p>
