  ...
  function (templateFactory, busService) {
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        scope.templateURL = '/apps/ikApp/shared/elements/slide/slide-loading.html?' + window.config.version;
      ...
      templateUrl: '/apps/ikApp/shared/elements/slide/slide-edit.html?' + window.config.version
    };
  }
]);
